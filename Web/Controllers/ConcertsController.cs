...
namespace Web.Controllers
{
    public class ConcertsController : Controller
    {
        ...
        [Authorize]
        public async Task<IActionResult> Create([Bind("Id,Name,DateAndTime,Place,Price")] Concert concert)
        {
        ...
        [ValidateAntiForgeryToken]
        [Authorize]
        public async Task<IActionResult> Edit(Guid id, [Bind("Id,Name,DateAndTime,Place,Price")] Concert concert)
        {
            if (id != concert.Id)
            {
                return NotFound();
